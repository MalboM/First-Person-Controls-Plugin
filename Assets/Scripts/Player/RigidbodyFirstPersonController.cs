...
/// <summary>
/// Controller of player movement. New rigidbody version.
/// </summary>
...
public class RigidbodyFirstPersonController : MonoBehaviour
{
    ...
    public class MovementSettings
    {
        ...
        [HideInInspector] public float JumpSpeed = 0.0f; // WILL BE COMPUTED
    ...
    public class AdvancedSettings
    {
        ...
        public bool useOriginalGameMovement = false;    // Uses the movement of the original game
        public bool useRelativeJumpSpeed = false; // True: jump speed overrides current speed
    }
    ...
    private void FixedUpdate()
    {
        ...
        if (isGivingMovementInput && (advancedSettings.airControl || isGrounded))
        {
            ...
            if (!isGrounded)
            {
                ...
                //s += "\nFLYING MOVE: " + desiredMove;
            }

            desiredMove = desiredMove * SlopeMultiplier(desiredMove);
            //s += "\n Actual force impulse: " + desiredMove;

            // Clamp X-Z velocity (without affecting y)
            //s += "\n Previous velocity: " + RigidBody.velocity;
            ...
            //s += "\n Clamped velocity: " + RigidBody.velocity;

            if (advancedSettings.useOriginalGameMovement)
            {
            ...
            //s += "\n Current velocity: " + RigidBody.velocity;
